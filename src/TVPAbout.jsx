      ...
      <div className="pr-14 pl-14 pt-7">
        <div className="bg-white mb-8 shadow-2xl flex rounded-xl ">
          <div className="flex-col content-center">
            <div className="bg">
              <div className="pl-4 pt-3 pb-2 text-lg font-medium">
                <h1>$ {hotels.price}</h1>
              </div>
              <div className="flex">
                <div className="p-4">
                ...
                <div className="pl-20 flex pr-20 ">
                  <Link
                    className="bg-blue-500 p-2 pl-5 w-28 h-10 rounded-md text-white"
                    to={`${hotels.id}`}
                  >
                    Book Now
                  </Link>                                                                       
