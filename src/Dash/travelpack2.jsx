...
const Home2 = () => {
  ...
  const loadHotelsFromLocalStorage = () => {
    const storedHotels = localStorage.getItem("TravelPackages");
    if (storedHotels) {
  ...
  const saveHotelsToLocalStorage = (hotels) => {
    localStorage.setItem("TravelPackages", JSON.stringify(hotels));
  };
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold pb-4">Travel Packages</h1>
      ...
      {showForm && (
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <h1 className="text-xl font-bold pb-4">{editMode ? "Update Travel Packages" : "Add Travel Packages"}</h1>
          <div className="mb-4">
            <label
